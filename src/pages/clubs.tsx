...
const athletic_club: Club[] = [
  ...
  { name: '女子バスケ部', instagram: 'https://twitter.com/manken_mct' },
  { name: 'ソフトテニス部' },
  {
    name: 'ボート部',
...
const cultural_club: Club[] = [
  ...
  {
    name: '吹奏楽部',
    twitter: 'https://twitter.com/mctbb_prm',
    facebook: 'https://www.facebook.com/mctwind/',
    instagram: 'https://www.instagram.com/mct_windclub/',
  },
  { name: '文芸部' },
  { name: '書道部' },
  { name: 'ESS部' },
